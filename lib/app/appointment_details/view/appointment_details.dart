  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: "Randevu Ayrıntıları".text.make(),
      ),
      body: Padding(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  10.heightBox,
                  "Randevu Günü".text.semiBold.make(),
                  doc['appDay'].toString().text.make(),
                  10.heightBox,
                  "Randevu Saati".text.semiBold.make(),
                  doc['appTime'].toString().text.make(),
                  10.heightBox,
                  "Hasta Adı".text.semiBold.make(),
                  doc['appName'].toString().text.make(),
                  10.heightBox,
                  "Hasta Numarası".text.semiBold.make(),
                  doc['appMobile'].toString().text.make(),
                  10.heightBox,
                  "Şikayetler".text.semiBold.make(),
